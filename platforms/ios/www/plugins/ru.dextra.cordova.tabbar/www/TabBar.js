cordova.define("ru.dextra.cordova.tabbar.tabbar", function(require, exports, module) {/*
 ...
 */
               ...
               //    alert(JSON.stringify(this.callbacks));
...
/**
 * Manually select an individual tab from its name
 * @param {String} tabname to select
 * @see createItem
 * @see showItems
 */
               TabBar.prototype.setSelectedTab = function(index) {
               cordova.exec(null, null, "TabBar", "setSelectedTab", [index]);
               };
